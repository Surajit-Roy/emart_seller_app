            ...
            return Column(
                    children: [
                      ListTile(
                        ...
                        Image.asset(imgProduct, width: 70, fit: BoxFit.cover).box.roundedFull.clip(Clip.antiAlias).make():
                        Image.network(controller.snapshotData['imageUrl'], width: 70,).box.roundedFull.clip(Clip.antiAlias).make(),
